...
async def psu(event):
    ...
    help_string += f"**Pʏ-ɪᴛᴀᴄʜɪ-ᴜꜱᴇʀʙᴏᴛ :** `{py_ver}`\n"
    help_string += f"**ɪᴛᴀᴄʜɪ-ᴜꜱᴇʀʙᴏᴛ-Vᴇʀsɪᴏɴ :** `{ayiin_version} [{HOSTED_ON}]`"
...
async def amireallyalive(alive):
    ...
    output = (
        f"**Tʜᴇ [ɪᴛᴀᴄʜɪ-ᴜꜱᴇʀʙᴏᴛ](https://github.com/herokustuf1/Itachi-Userbot)**\n\n"
        f"**{alive_text}**\n\n"
        f"╭✠╼━━━━━━━━━━━━━━━✠╮\n"
        ...
        f"{emoji} **Pʏ-ɪᴛᴀᴄʜɪ-ᴜꜱᴇʀʙᴏᴛ Vᴇʀsɪᴏɴ :** `{py_ver}`\n"
        f"{emoji} **ɪᴛᴀᴄʜɪ-ᴜꜱᴇʀʙᴏᴛ Vᴇʀsɪᴏɴ :** `{ayiin_version}` [{HOSTED_ON}]\n"
