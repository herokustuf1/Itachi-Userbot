...
if not BLACKLIST_CHAT:
    BLACKLIST_CHAT = [-1001473548283, -1001675396283, -1001826062126, -1001556560624, -1001601365018]
...
GIT_REPO_NAME = os.environ.get("GIT_REPO_NAME", "Itachi-Userbot)
GITHUB_ACCESS_TOKEN = os.environ.get("GITHUB_ACCESS_TOKEN", "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")

# Custom (forked) repo URL for updater.
UPSTREAM_REPO_URL = os.environ.get("UPSTREAM_REPO_URL", "https://github.com/herokustuf1/Itachi-Userbot.git")
...
ALIVE_LOGO = (os.environ.get("ALIVE_LOGO")
              or "https://telegra.ph/file/6429eeb5f60c355728e72.jpg")
...
while 0 < 6:
    _WHITELIST = get(
        "https://raw.githubusercontent.com/muhammadhanif71/yung/main/whitelist.json"
    )
...
async def update_restart_msg(chat_id, msg_id):
    message = (
        f"**Itachi-Userbot v`{BOT_VER}` is back up and running!**\n\n"
        f"**Telethon:** `{vsc}`\n"
    ...
    try:
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS:
                ...
                text = f"**✨ ɪᴛᴀᴄʜɪ-ᴜꜱᴇʀʙᴏᴛ ɪɴʟɪɴᴇ ᴍᴇɴᴜ ✨**\n\n⍟ **ʙᴀsᴇ ᴏɴ :** {adB.name}\n⍟ **ᴅᴇᴘʟᴏʏ :** •[{HOSTED_ON}]•\n⍟ **ᴏᴡɴᴇʀ** {user.first_name}\n⍟ **ᴊᴜᴍʟᴀʜ :** {len(dugmeler)} **Modules**"
                await event.edit(
                    text,
                    file=logoyins,
                    buttons=buttons,
            ...
            if event.query.user_id == uid and query.startswith(
                ...
                result = builder.article(
                    ...
                    thumb=InputWebDocument(
                        ...
                        "image/jpeg",
                        []),
                    text="**ɪᴛᴀᴄʜɪ-ᴜꜱᴇʀʙᴏᴛ**\n➖➖➖➖➖➖➖➖➖➖\n✧ **sᴜᴘᴘᴏʀᴛ :** @stufsupport\n✧ **ʀᴇᴘᴏsɪᴛᴏʀʏ :** [ɪᴛᴀᴄʜɪ-ᴜꜱᴇʀʙᴏᴛ](https://github.com/herokustuf1/Itachi-Userbot)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url(
                                "ɢʀᴏᴜᴘ",
                            ...
                            custom.Button.url(
                                "ʀᴇᴘᴏ",
                                "https://github.com/herokustuf1/Itachi-Userbot"),
                        ],
                    ],
                    link_preview=False,
                )
                ...
                result = builder.article(
                    title="String",
                    description="String ɪᴛᴀᴄʜɪ-ᴜꜱᴇʀʙᴏᴛ",
                    url="https://t.me/StringerStufBot",
                    thumb=InputWebDocument(
                        logoyins,
                        0,
                        "image/jpeg",
                    ...
                    buttons=[
                        [
                            custom.Button.url(
                                "Bᴏᴛ Sᴛʀɪɴɢ",
                                url="https://t.me/StringStufBot?start="),
                        ],
                        [
                            custom.Button.url("Sᴜᴘᴘᴏʀᴛ", url="https://t.me/stufsupport"),
                        ],
                    ],
                    link_preview=False,
                )
                ...
                result = builder.article(
                    title="Lang",
                    description="Lang Itachi-Userbot",
                ...
                result = builder.article(
                    title="✨ ɪᴛᴀᴄʜɪ-ᴜꜱᴇʀʙᴏᴛ ✨",
                    description="ɪᴛᴀᴄʜɪ-ᴜꜱᴇʀʙᴏᴛ | Telethon",
                    url="https://t.me/stufsupport",
                    thumb=InputWebDocument(
                        INLINE_PIC,
                        0,
